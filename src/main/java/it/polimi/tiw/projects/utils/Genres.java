...
public enum Genres {
    AFRICAN("Music of Africa"),
    ALTERNATIVEROCK("Alternative rock"),
    AMBIENT("Ambient music"),
    AMERICANFOLK("American folk music"),
    ASIAN("Music of Asia"),
    BLUES("Blues"),
    ...
    FOLK("Folk music"),
    FUNK("Funk"),
    GENEALOGY("Genealogy of musical genres"),
    GOSPEL("Gospel music"),
    HARDCORE("Hardcore"),
    HEAVYMETAL("Heavy metal"),
    HIPHOP("Hip-hop"),
    HIPHOPCULTURE("Hip-hop culture"),
    HOUSE("House music"),
    ...
    JAZZ("Jazz"),
    KPOP("K-pop"),
    LATINAMERICAN("Music of Latin America"),
    MIDDLEEASTERN("Middle Eastern music"),
    MODERNISM("Modernism"),
