...
/**
 * A registry to hold and provide access to Song objects globally.
...
public class SongRegistry {
    ...
    /**
     * Initializes the registry with a collection of songs.
    ...
    /**
     * Retrieves all songs stored in the registry.
