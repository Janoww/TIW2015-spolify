...
public class AlbumDAO {
    ...
    public AlbumDAO(@NotNull Connection connection) {
     ...
     */
    public Album createAlbum(@NotBlank String name, int year, @NotBlank String artist, String image,
     ...
     */
    public @NotNull Album findAlbumById(int idAlbum) throws DAOException {
     ...
     *                      ({@link it.polimi.tiw.projects.exceptions.DAOException.DAOErrorType#GENERIC_ERROR}).
     */
    public List<Album> findAlbumsByUser(@NotNull UUID userId) throws DAOException {
     ...
     */
    public void updateAlbum(int idAlbum, @NotNull UUID userId, String name, Integer year, String artist, String image)
            throws DAOException {
        logger.debug(
     ...
     *                      ({@link it.polimi.tiw.projects.exceptions.DAOException.DAOErrorType#NOT_FOUND}).
     */
    public void deleteAlbum(int idAlbum, @NotNull UUID userId) throws DAOException {
